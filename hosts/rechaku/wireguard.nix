...

{
  ...
  systemd.network = {
    netdevs."30-wg-public" = {
      ...
      wireguardPeers = [
        ...
        { # abraxas
          wireguardPeerConfig = {
            AllowedIPs = [
              "2a01:4f8:c17:235a:1000::4/128"
            ];
            PublicKey = "tpAq5+cS4VlRP7/GgPGLllwAChiQTxe0IjW4uVKvpUs=";
          };
        }
      ];
    };
    networks."30-wg-public" = {
      ...
      address = [
        "2a01:4f8:c17:235a:1000::1/128"
      ];
      networkConfig = {
        IPForward = true;
      };
      routes = [
        { routeConfig.Destination = "2a01:4f8:c17:235a:1000::/68"; }
      ];
    };
    ...
    networks."30-wg-server" = {
      ...
      routes = [
        ...
        { routeConfig.Destination = "10.151.12.0/22"; }
