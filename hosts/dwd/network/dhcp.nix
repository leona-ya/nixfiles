...

{
  services.dhcpd4 = {
    ...
    extraConfig = ''
      ...
      option domain-name "lan.int.sig.de.em0lar.dev";
      option domain-name-servers 10.151.0.1;
      ddns-domainname "lan.int.sig.de.em0lar.dev";
      ...
      # STATIC IPs
      host coreswitch {
        option host-name "coreswitch.lan.int.sig.de.em0lar.dev";
        hardware ethernet a4:2b:8c:12:5b:96;
        fixed-address 10.151.0.4;
       }
      host ap-unifi-1 {
        option host-name "ap-unifi-1.lan.int.sig.de.em0lar.dev";
        hardware ethernet 80:2a:a8:93:df:57;
        fixed-address 10.151.0.129;
       }
      host ap-unifi-2 {
        option host-name "ap-unifi-2.lan.int.sig.de.em0lar.dev";
        hardware ethernet fc:ec:da:3a:24:67;
        fixed-address 10.151.0.130;
      }
      host hue {
        option host-name "hue.lan.int.sig.de.em0lar.dev";
