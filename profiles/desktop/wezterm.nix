{ config, pkgs, ... }: {
  home-manager.users.leona = {
    ...
    xdg.configFile = let 
      cfg = config.home-manager.users.leona.programs.wezterm;
      defaultText = ''
    ...
    in {
      ...
      "wezterm/wezterm-dark-theme.lua".text = ''
        ${defaultText}
        config.color_scheme = "monokai_pro"

        return config
      '';
      "wezterm/wezterm-light-theme.lua".text = ''
        ${defaultText}
        config.color_scheme = "monokai_pro_light"

        return config
      '';
    };
    services.darkman = {
      darkModeScripts.wezterm = ''
        ${pkgs.coreutils}/bin/ln -fs wezterm-dark-theme.lua ~/.config/wezterm/wezterm.lua
      '';
      lightModeScripts.wezterm = ''
        ${pkgs.coreutils}/bin/ln -fs wezterm-light-theme.lua ~/.config/wezterm/wezterm.lua
      '';
    };
  };
}
