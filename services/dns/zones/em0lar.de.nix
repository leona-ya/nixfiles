...

{
  zone = with dns.lib.combinators; {
    ...
    subdomains = {
      ...
      "dkim._domainkey.ml".TXT = [
        (txt ''v=DKIM1;k=rsa;t=s;s=email;p=" "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEApfjwwui6to37BbwmY6O6dTLeF/1MBDqlqWWKyvP+18lGeYG00y+QtTSmyqmens/tjDqX7mTX1v4PIuddT6KMUuvy28VADka4gLtpgReRuF8+4VMyPAN3ziLQapH8Fgw2ZhucdFcz14S8MKls26T94iyrn43UlpqfauxGcPDqbhu18Wfy5EgJLhqlTKYv1xVM2Fvx0k+HQFY7RQ" "MF5gzzY0ToTv3kqbf8r/w39vPgwEODQT2RD5IdbNe5yXTphmwN1+uydFfYqj62EzPUKD4nCCe1RDh5GtHTGAsKt8KdVufZBIML4EYolh8iyIdozn8JtcOqdagE9ToF6gVvtvnkJwIDAQAB'')
      ];
      ...
      "dkim._domainkey.ca".TXT = [
        (txt ''v=DKIM1;k=rsa;t=s;s=email;p=" "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAruAiCE8lXVKqR0nihVRuiLUiAk0yGikVKLj/IsFGvl8GH88DtfaZhss0XCOY9m7fIQPf0j3dh3bFrbh3sPX5hhgZwv+sV/KLR1JhESduVnksZC1w+ZKhjjBoNFkBdSsPuU0bp7KBGjGJ8hS4H3M2AxOF0SnpR1kUAL9j+IFwi0KGuKuuX03RHCZVWGNjt72qKdFRNIW9BlK/AqZXG" "0toPfkMCRIluH1aGJmN9kIgc8Q/dJeXWfGBgGvW1Idc708XlnoLOkM5Giajmz2+gC+BcOCJf4/WFm7c6ZRzsuM6yVXdKT7bSm4ey6duZ9MIyeDQD83CbsXC6BBwP/JN6ZHrwwIDAQAB'')
      ];
