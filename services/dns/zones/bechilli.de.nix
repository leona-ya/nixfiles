...

{
  zone = with dns.lib.combinators; {
    ...
    subdomains = {
      "dkim._domainkey".TXT = [
        (txt ''v=DKIM1;k=rsa;t=s;s=email;p=" "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAuISn/WfY8hxks4zcwPXi+mzyTLe5PP4bRS/uTx3ldsjOWWqMyBD5l6UCXoFWedG1rpaUasjh96lglK+GvJdBDd+9pOksMezT/1xhhjO2QT2ughQ1yXFbA4CSraeZOROyWm0KMFLg6Cl9Q4GKsJiLioG/rj6zi6Qq1B7qv/ZgF45BQGYM7tr+mypTWsOpl1JN9ynHrhfp+YrpPbHFI" "j+Hjs18T6JVLGQw81RQYUi30CrnUYYwYOxCpESdIXdcv4RshdjJmyEP/dwr1GeW6reWkeO0GFV+szAFSzDH0CPMfoS7z8wCMuMk1j2qiRnqgFFpIWbVlgp2Om/bN6fK/tyAeQIDAQAB'')
      ];
    };
  };
}
