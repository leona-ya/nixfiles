...
{ name, product, version, src, wmClass, jdk, meta, execFileName ? lib.toLower product, extraLdPath ? [] }@args:
...
with stdenv; lib.makeOverridable mkDerivation (rec {
  ...
  installPhase = ''
    ...
    makeWrapper "$out/$name/bin/${execFileName}.sh" "$out/bin/${mainProgram}" \
