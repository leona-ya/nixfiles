...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchurl {
    url = "http://cdn.waterfox.com/waterfox/releases/${finalAttrs.version}/Linux_x86_64/waterfox-${finalAttrs.version}.tar.bz2";
    hash = "sha256-e8i29fR6m+8hSo2Oc9DYD++tnhSlbSKsFAeRacPVT7k=";
  };
